...
#summary(cvalid.out)
```
We can save time by only running this cell once and loading the results otherwise: ![clValid results](Figures/clustering-results.png)
...
```
Likewise, computed all 30 indices every time the script is ran is quite time-consuming. We will only uncomment this cell when needed. 
