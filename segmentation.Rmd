...
- Furthermore, gap statistic has a clear elbow at k = 2 for k-means. And when considering 30 different indices for clustering performance, 10 proposed 2 as the best number of clusters while only 4 proposed 3 as the best number of clusters (for k-means). 
