...
- This is corroborated by the fact that k-means with k = 2 produced the maximal silhouette statistic. Silhouette also suggests that k =2 is optimal for PAMS as well. 
- Visually this seems like an acceptable result. Both PAM (k-medoids) and k-means are neatly separated along the first principal component in this way into clusters of roughly the same size. 
...
### Factoextra hierarchical clustering
```{r fa-hierarchical}
