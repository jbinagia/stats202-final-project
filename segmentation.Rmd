...
## Further reading
- [Extracting features?](https://towardsdatascience.com/10-tips-for-choosing-the-optimal-number-of-clusters-277e93d72d92)
...
fviz_cluster(km.out, maxitems = 3000, scaled_df,geom = c("point"))
```
