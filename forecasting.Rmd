...
"Note that we ended up not removing these 410 observations since I considered them distinct from the test set (the test set has VisitDay shifted upwards by a value of 7).": -> we should remove these, and not do the + 7 for the test set. You did remove them above. 
