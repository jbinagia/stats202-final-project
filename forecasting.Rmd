...
# hyperparameter grid
hyper_grid.h2o <- list(
  ntrees      = seq(300, 450, by = 50), 
  mtries      = 2,
  max_depth   = seq(15, 35, by = 5),
  min_rows    = seq(7, 10, by = 1), 
  nbins       = seq(15, 30, by = 5),
  sample_rate = c(0.35,0.45,.55) 
) 
...
) # best model from this has test MSE of 131.1589. best model while using study E gave 130.52. Latter scored 121.37919 on the public leaderboard.
