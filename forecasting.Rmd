...
Top 5 models all have `max_depth` of 5 when the options are 1, 3, and 5. Same if the options are 1, 5, 10. Chooses 4 if options are 3,4,5,6,7 so let's keep it below 4. They also always have `learn_rate_annealing` of 1. Best column sample rates are never 1, always 0.8 or 0.9. 
