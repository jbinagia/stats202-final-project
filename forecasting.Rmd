...
### Tuning
We will now tune the hyperparameters. Note that we only have a few predictors, so we wills can `mtry` from 2 to 4. 
```{r rf-initial-tuning}
# set.seed(1)
# m2 <- tuneRF(
#   x          = training_df[,-c("PatientID","PANSS_Total")],
#   y          = training_df$PAMSS_Total,
#   ntreeTry   = 500,
#   mtryStart  = 2,
#   stepFactor = 1.5,
#   improve    = 0.01,
