...
# create hyperparameter grid
hyper_grid <- list(
  max_depth = c(1,3,5), # depth of each tree
...
62 models took 5 mins to evaluate. Top 5 models after 5 mins all had max_depth of 5. Top 4 has min_rows = 1. All had learning rate > 0.05. Top 5 on second run all have min_rows = 1. 
