...
# # ROC curves
# library(ROCR)
# prediction(dev.log.all.pred$posterior[,2], combined.dev.all$LeadStatus) %>%
...
# 
# # Cross-entropy 
# prediction(dev.log.all.pred$posterior[,2], ifelse(combined.dev.all$LeadStatus=="Passed", 1, 0)) %>%
