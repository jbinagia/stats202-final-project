...
## QDA
I would like to try QDA but it was giving me errors. 
```{r qda-start}
...
## SVM
SVMs might work but the issue is we do not have much experience in obtaining probabilities from SVMs. 
<!-- ```{r svm-intro} -->
<!-- library(e1071)        # SVM methodology -->
<!-- set.seed(1) -->

<!-- svmfit <- svm(LeadStatus~., data = combined.train, kernel = "linear", scale=TRUE) -->
<!-- summary(svmfit) -->
<!-- ``` -->
...
<!-- ```{r svm-accuracy} -->
<!-- dev.svm.pred = predict(svmfit) -->
<!-- table(dev.svm.pred, combined.train$LeadStatus) -->

<!-- dev.svm.pred = predict(svmfit, newdata=combined.dev) -->
<!-- table(dev.svm.pred, combined.dev$LeadStatus) -->
...
<!-- logLoss(combined.dev$LeadStatus,dev.svm.pred) -->
<!-- ``` -->
